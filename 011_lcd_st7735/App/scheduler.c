...
task_t Scheduler_Task[] = {
	{task_led0_proc,	5,	0},		  	// GPIO端口扫描，每20毫秒执行一次
	{task_led1_proc,	5,	0},
	{task_beep_proc,	5,	0},
//	{task_key_gets, 	5,	0},		  	// 普通按键扫描
//	{task_smg_proc,		100,0},			// 数码管扫描，不可与OLED LCD复用
//	{task_smg_scan,		2,	0},
	{task_adc_key_proc,10,	0},			// ADC按键扫描
	{task_lcd_proc,		100,0}			// LCD ui界面扫描
};
